...
//             frappe.call({
//                 method: 'library_management.library_management.doctype.company_details.company_details.calculate_total_amount_form',
//                 args: {
...
frappe.realtime.on('company_details', function(data) {
    frappe.throw(`Company "${data.company_name}" submitted with status "${data.status}"`);
});
...
frappe.ui.form.on('Company Details', {
    refresh: function(frm) {
        frm.add_custom_button('Calculate Total', function() {
            frappe.call({
                method: 'library_management.library_management.doctype.company_details.company_details.has_price_changed',
                args: {
